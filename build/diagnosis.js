...
راه حل 3: از پشتیبانی درخواست فایل سرتیفیکیت کنین.`,
    ...
    bot.callbackQuery("diagnosis", (ctx) => __awaiter(void 0, void 0, void 0, function* () {
        yield ctx.answerCallbackQuery();
        yield ctx.editMessageText(text, { reply_markup: keyboard });
    }));
    // diagnosis answer
    bot.callbackQuery(/^diagnosis:([0-9]+)$/g, (ctx) => __awaiter(void 0, void 0, void 0, function* () {
        const q = parseInt(ctx.match[1]) - 1;
        const keyboard = new grammy_1.InlineKeyboard()
            .text("برگشت ↩️", "diagnosis")
            .text("صفحه اصلی 🏠", "mainMenu");
        yield ctx.editMessageText(`🛠 ${diagnosisList[q][0]}\n\n💭 ${diagnosisList[q][1]}`, { reply_markup: keyboard });
        yield ctx.answerCallbackQuery();
    }));
};
